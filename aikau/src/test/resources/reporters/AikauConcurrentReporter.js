define([
   ...
   function initCharm() {
      ...
      charm.position(1, 2);
      charm.write(ANSI_COLORS.Bold);
      charm.write("  ==================\n");
      charm.write("   AIKAU UNIT TESTS \n");
      charm.write("  ==================");
      charm.write(ANSI_COLORS.Reset);

      // Create the reporting window
      charm.position(3, 6);
      charm.write("Environments: ");
      charm.position(function(x, /*jshint unused:false*/ y){
         charm.write("xPos=" + x);
         lineEndings.environments = x;
      });
   }
